...
sys.path.insert(0, "/mnt/public-data/shared/public/trajcaching_v3/debs/proto")
sys.path.insert(0, "/mnt/public-data/shared/public/trajcaching_v3/debs/scenariohouse")
...
def get_car_config(trip_id):
    ...
    car_config = dr_client.download_bytes(
        GetFileRequest(
            namespace='trip',
            path=f"/{trip_name}/configs/car_config.cfg",
        )
    )
    car_config = extract_params(car_config)
    return car_config
