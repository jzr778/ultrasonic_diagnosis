...
#ifndef GOOGLE_PROTOBUF_INCLUDED_smart_2fdriving_2fsmart_5fdriving_5fdwm_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_smart_2fdriving_2fsmart_5fdriving_5fdwm_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_smart_2fdriving_2fsmart_5fdriving_5fdwm_2eproto
...
struct TableStruct_smart_2fdriving_2fsmart_5fdriving_5fdwm_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_smart_2fdriving_2fsmart_5fdriving_5fdwm_2eproto;
PROTOBUF_NAMESPACE_OPEN
PROTOBUF_NAMESPACE_CLOSE
namespace smart {

enum DrivingDwmUID : int {
  ...
  DrivingDwmUID_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  DrivingDwmUID_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool DrivingDwmUID_IsValid(int value);
constexpr DrivingDwmUID DrivingDwmUID_MIN = DRIVING_DWM_DEFAULT_ID;
constexpr DrivingDwmUID DrivingDwmUID_MAX = DRIVING_DWM_FAULT_59102;
constexpr int DrivingDwmUID_ARRAYSIZE = DrivingDwmUID_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* DrivingDwmUID_descriptor();
template<typename T>
inline const std::string& DrivingDwmUID_Name(T enum_t_value) {
  static_assert(::std::is_same<T, DrivingDwmUID>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function DrivingDwmUID_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    DrivingDwmUID_descriptor(), enum_t_value);
}
inline bool DrivingDwmUID_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, DrivingDwmUID* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<DrivingDwmUID>(
    DrivingDwmUID_descriptor(), name, value);
}
// ===================================================================
...
template <> struct is_proto_enum< ::smart::DrivingDwmUID> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::smart::DrivingDwmUID>() {
  return ::smart::DrivingDwmUID_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_smart_2fdriving_2fsmart_5fdriving_5fdwm_2eproto
