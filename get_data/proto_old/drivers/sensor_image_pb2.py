...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='drivers/sensor_image.proto',
...
_PIXELFORMAT = _descriptor.EnumDescriptor(
  name='PixelFormat',
  full_name='deeproute.drivers.PixelFormat',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_IMAGE = _descriptor.Descriptor(
  name='Image',
  full_name='deeproute.drivers.Image',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='header', full_name='deeproute.drivers.Image.header', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='height', full_name='deeproute.drivers.Image.height', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='width', full_name='deeproute.drivers.Image.width', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='encoding', full_name='deeproute.drivers.Image.encoding', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='is_bigendian', full_name='deeproute.drivers.Image.is_bigendian', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='step', full_name='deeproute.drivers.Image.step', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='data', full_name='deeproute.drivers.Image.data', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pixel_format', full_name='deeproute.drivers.Image.pixel_format', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='exposure_duration_ns', full_name='deeproute.drivers.Image.exposure_duration_ns', index=8,
...
_COMPRESSEDIMAGE = _descriptor.Descriptor(
  ...
  full_name='deeproute.drivers.CompressedImage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='header', full_name='deeproute.drivers.CompressedImage.header', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='format', full_name='deeproute.drivers.CompressedImage.format', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='data', full_name='deeproute.drivers.CompressedImage.data', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='exposure_duration_ns', full_name='deeproute.drivers.CompressedImage.exposure_duration_ns', index=3,
...
_IMAGE.fields_by_name['header'].message_type = common_dot_header__pb2._HEADER
_IMAGE.fields_by_name['pixel_format'].enum_type = _PIXELFORMAT
_COMPRESSEDIMAGE.fields_by_name['header'].message_type = common_dot_header__pb2._HEADER
