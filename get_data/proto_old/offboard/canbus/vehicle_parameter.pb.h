...
#ifndef GOOGLE_PROTOBUF_INCLUDED_offboard_2fcanbus_2fvehicle_5fparameter_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_offboard_2fcanbus_2fvehicle_5fparameter_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_offboard_2fcanbus_2fvehicle_5fparameter_2eproto
...
struct TableStruct_offboard_2fcanbus_2fvehicle_5fparameter_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_offboard_2fcanbus_2fvehicle_5fparameter_2eproto;
namespace deeproute {
namespace canbus {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::deeproute::canbus::VehicleParameter* Arena::CreateMaybeMessage<::deeproute::canbus::VehicleParameter>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace deeproute {
namespace canbus {
...
class VehicleParameter PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:deeproute.canbus.VehicleParameter) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "deeproute.canbus.VehicleParameter";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_offboard_2fcanbus_2fvehicle_5fparameter_2eproto);
    return ::descriptor_table_offboard_2fcanbus_2fvehicle_5fparameter_2eproto.file_level_metadata[kIndexInFileMessages];
  }
 ...
 private:
  ...
  int driving_mode_;
  friend struct ::TableStruct_offboard_2fcanbus_2fvehicle_5fparameter_2eproto;
};
// ===================================================================
...
inline ::deeproute::common::VehicleBrand VehicleParameter::_internal_brand() const {
  return static_cast< ::deeproute::common::VehicleBrand >(brand_);
}
inline ::deeproute::common::VehicleBrand VehicleParameter::brand() const {
  // @@protoc_insertion_point(field_get:deeproute.canbus.VehicleParameter.brand)
  return _internal_brand();
}
inline void VehicleParameter::_internal_set_brand(::deeproute::common::VehicleBrand value) {
  assert(::deeproute::common::VehicleBrand_IsValid(value));
  _has_bits_[0] |= 0x00000002u;
  brand_ = value;
}
inline void VehicleParameter::set_brand(::deeproute::common::VehicleBrand value) {
  _internal_set_brand(value);
  // @@protoc_insertion_point(field_set:deeproute.canbus.VehicleParameter.brand)
}
...
inline double VehicleParameter::max_engine_pedal() const {
  // @@protoc_insertion_point(field_get:deeproute.canbus.VehicleParameter.max_engine_pedal)
...
inline void VehicleParameter::set_max_engine_pedal(double value) {
  ...
  // @@protoc_insertion_point(field_set:deeproute.canbus.VehicleParameter.max_engine_pedal)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 VehicleParameter::max_enable_fail_attempt() const {
  // @@protoc_insertion_point(field_get:deeproute.canbus.VehicleParameter.max_enable_fail_attempt)
...
inline void VehicleParameter::set_max_enable_fail_attempt(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:deeproute.canbus.VehicleParameter.max_enable_fail_attempt)
}
...
inline ::deeproute::canbus::Chassis_DrivingMode VehicleParameter::_internal_driving_mode() const {
  return static_cast< ::deeproute::canbus::Chassis_DrivingMode >(driving_mode_);
}
inline ::deeproute::canbus::Chassis_DrivingMode VehicleParameter::driving_mode() const {
  // @@protoc_insertion_point(field_get:deeproute.canbus.VehicleParameter.driving_mode)
  return _internal_driving_mode();
}
inline void VehicleParameter::_internal_set_driving_mode(::deeproute::canbus::Chassis_DrivingMode value) {
  assert(::deeproute::canbus::Chassis_DrivingMode_IsValid(value));
  _has_bits_[0] |= 0x00000008u;
  driving_mode_ = value;
}
inline void VehicleParameter::set_driving_mode(::deeproute::canbus::Chassis_DrivingMode value) {
  _internal_set_driving_mode(value);
  // @@protoc_insertion_point(field_set:deeproute.canbus.VehicleParameter.driving_mode)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_offboard_2fcanbus_2fvehicle_5fparameter_2eproto
