...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='semantic_map/map_signal.proto',
  ...
  ,
  dependencies=[common_dot_geometry__pb2.DESCRIPTOR,semantic__map_dot_map__geometry__pb2.DESCRIPTOR,])
...
_SUBSIGNAL.fields_by_name['location'].message_type = common_dot_geometry__pb2._POINTENU
...
_SIGNAL.fields_by_name['boundary'].message_type = common_dot_geometry__pb2._POLYGON
_SIGNAL.fields_by_name['subsignal'].message_type = _SUBSIGNAL
_SIGNAL.fields_by_name['type'].enum_type = _SIGNAL_TYPE
_SIGNAL.fields_by_name['stop_line'].message_type = semantic__map_dot_map__geometry__pb2._CURVE
