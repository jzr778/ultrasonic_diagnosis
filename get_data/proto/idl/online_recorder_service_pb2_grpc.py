...
from idl import online_recorder_service_pb2 as idl_dot_online__recorder__service__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in idl/online_recorder_service_pb2_grpc.py depends on'
...
def add_OnlineRecorderServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('deeproute.online_recorder_service.OnlineRecorderService', rpc_method_handlers)
