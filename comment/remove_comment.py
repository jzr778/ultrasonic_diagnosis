...
class FeishuCommentTester:
    ...
    def create_comment_with_mention(self, project_key: str, work_item_type_key: str, 
                                  work_item_id: str, comment_id: str,
        ...
        url = f"{self.endpoint}/{project_key}/work_item/{work_item_type_key}/{work_item_id}/comment/" + comment_id
        headers = {
            "Content-Type": "application/json",
            "X-USER-KEY": self.USER_KEY,
            "X-PLUGIN-TOKEN": self.token,
    ...
    def test_comment(self, project_url: str, comment_id: str = "7592894301513452510"):
        """测试评论功能的主方法"""
        try:
            print("🚀 开始测试飞书项目评论功能")
            print("=" * 50)
...
if __name__ == "__main__":
    ...
    tester.test_comment(test_url, "7600343208769686727")
